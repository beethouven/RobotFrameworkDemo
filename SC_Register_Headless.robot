...
Set Log and folder
    Open Browser                    https://adultfriendfinder.com/                  headlesschrome
...
Go AFF
    Open Browser                    https://adultfriendfinder.com/?lang=english&debug_cookie=fake_ip:65.7.63.115        headlesschrome       alias=Sender
    Set Window Size    1920    1080
    Maximize Browser Window
...
Go AFF And Login
    Open Browser                        https://adultfriendfinder.com?lang=english&debug_cookie=fake_ip:65.7.63.115          headlesschrome   alias=Recevier
    Set Window Size    1920    1080
    Maximize Browser Window
...
Go Checking Flirt
    ...
    capture page screenshot               ${Folder}CheckFlirt.jpg
...
Go Checking Hotlist
    ...
    Wait Until Page Contains Element    xpath://strong[text()=${Account_String}]                            10s
    capture page screenshot             ${Folder}CheckHotlist.jpg
...
Go Checking Friend
    ...
    capture page screenshot             ${Folder}CheckFriend.jpg
...
Go Change Mail
    ...
    capture page screenshot               ${Folder}ChangeMail.jpg

Go Change Password
    Go Account Page
    Change Password   ${Password}   ${Password_Changed}
    capture page screenshot               ${Folder}ChangePassword.jpg

Go Delete Account
    Go Account Page
    Delete Account                  ${Password_Changed}
    capture page screenshot               ${Folder}Delete.jpg

Go Admin
    Go admin by account             ${Admin_Account}  ${Admin_Password}  ${Account}
    capture page screenshot         ${Folder}FinalAdmin.jpg
...
Get Order History
    ...
    capture page screenshot         ${Folder}CheckOrder.jpg
